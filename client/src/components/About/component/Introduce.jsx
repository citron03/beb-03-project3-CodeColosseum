        ...
        <S.Introduce>
            ...
            <S.Div>
                <S.TextDiv>
                    ...
                    <S.P>문제를 제출하고, 토큰을 획들할 수 있습니다.</S.P>
                    <S.P>좋은 문제를 제출했다면, 추가적인 benefit을 얻을 수 있습니다.</S.P>
                    <S.P>해결한 문제를 평가해주세요. 다른 사용자에게 도움이 됩니다.</S.P>
                    <S.P>Code Colosseum 시간 제한이 있는 실전과 같은 환경을 제공합니다.</S.P>
                </S.TextDiv>
                <S.TextDiv>
                    <S.H2>Code Colosseum은 클레이튼 기반의 블록체인 웹 사이트입니다!</S.H2>
                    <S.P>토큰을 사용하여 콜로세움 문제에 도전할 수 있습니다.</S.P>
                    <S.P>당신이 제출한 문제를 NFT로 만들 수 있습니다.</S.P>
